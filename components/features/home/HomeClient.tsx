...
export function HomeClient({ settings }: HomeClientProps) {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-background text-foreground selection:bg-primary/20 selection:text-primary">
      ...
      {/* Mobile Homepage - App-like Dashboard */}
      <div className="lg:hidden">
        <MobileHome />
      </div>

      {/* Desktop Homepage - Google-like Hero */}
      <main id="main-content" className="hidden lg:flex relative z-10 mx-auto max-w-6xl flex-col items-center px-6 pt-16 sm:px-8 sm:pt-20 lg:pt-24">
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          >
            {settings?.homepage_hero_title || copy.home.hero.title.split(' ').slice(0, 2).join(' ')}
          </motion.h1>
        ...
        >
          {settings?.homepage_hero_subtitle || copy.home.hero.subtitle}
        </motion.p>
