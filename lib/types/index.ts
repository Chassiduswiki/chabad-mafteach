...
export interface Topic {
    ...
    // Content
    definition_short?: string; // "At a Glance" - 1-2 sentence summary
    definition_positive?: string; // Markdown - What it IS
    definition_negative?: string; // Markdown - What it's NOT
    overview?: string; // Markdown (Level 2: 200-400 words)
    article?: string; // Markdown (Level 3: 500-2000 words)
...
export interface TopicCitation {
    ...
    quoted_text_hebrew?: string; // Hebrew text
    quoted_text_english?: string; // English text
    context_note?: string;
